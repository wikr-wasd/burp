...
export const bs: Dictionary = {
  ...
  discover: {
    ...
    mapCluster: "{count} restorana ovdje",
  ...
  home: {
    ...
    searchButton: "Traži",
    searchHint: "Pretražuje nazive restorana, opise i menije.",
    searching: "Tražimo…",
    suggestEmpty: "Ništa ne odgovara upitu „{query}”. Pritisnite Enter za pretragu.",
    restaurantHits: "Restorani",
    cityHits: "Gradovi",
  ...
  restaurant: {
    ...
    findUs: "Kako do nas",
    documents: "Dokumenti",
    documentsHint: "Otvara se kao PDF.",
    reviews: "Recenzije",
  ...
  routes: {
    ...
    newRoute: "Nova ruta",
    newRoutePlaceholder: "Subota u Baščaršiji",
    create: "Napravi",
    creating: "Pravimo…",
    emptyTitle: "Još nema ruta",
    emptyBody: "Napravite jednu i dodajte mjesta s njihovih stranica.",
    stopCount: "{n} stajanja",
    changed: "Izmijenjeno {date}",
    noStops: "Ruta je prazna. Dodajte mjesto s njegove stranice.",
    addHint: "Dodajte još mjesta s njihovih stranica.",
    saveToRoute: "Sačuvaj u rutu",
    addTo: "Dodaj {name} u rutu",
    added: "Dodano.",
    fromPrevious: "{distance} zračnom linijom",
    totalDistance: "Ukupno {distance}, zračnom linijom",
    moveUp: "Pomjeri {name} gore",
    moveDown: "Pomjeri {name} dolje",
    removeStop: "Ukloni {name}",
    delete: "Obriši rutu",
    deleteConfirm: "Obrisati rutu? Ovo se ne može poništiti.",
    failed: "Nije uspjelo. Pokušajte ponovo.",
  },

  booking: {
    title: "Rezervišite sto",
    intro: "Izaberite dan, vrijeme i sto. Nije potreban račun.",
    date: "Datum",
    partySize: "Broj gostiju",
    chooseTime: "Izaberite vrijeme",
    searching: "Tražimo slobodne termine…",
    noTimes: "Tog dana nema slobodnih termina. Probajte drugi.",
    chooseTable: "Izaberite sto",
    tableLabel: "Sto {number}",
    standardTable: "Obični sto",
    surchargeHint: "Doplata se dodaje na račun u restoranu.",
    name: "Ime",
    phone: "Broj telefona",
    email: "E-pošta",
    note: "Trebamo li nešto znati?",
    notePlaceholder: "Stolica za bebe, alergija, rođendan",
    submit: "Rezerviši",
    submitting: "Rezervišemo…",
    attribute: {
      VIEW: "S pogledom",
      WINDOW: "Uz prozor",
      OUTDOOR: "U bašti",
    ...
    errorTaken: "Neko je bio brži. Izaberite drugo vrijeme.",
    errorPartyTooLarge: "Tako velika društva rezervišu se telefonom.",
    errorTooSoon: "Termin je prekratko unaprijed. Izaberite kasniji.",
    errorTooFar: "Toliko unaprijed još nije moguće rezervisati.",
    errorNoName: "Upišite ime na koje ide sto.",
    errorDisabled: "Restoran trenutno ne prima rezervacije.",
    errorUnknown: "Rezervacija nije prošla. Pokušajte ponovo.",
    confirmedTitle: "Sto je rezervisan",
    confirmedBody: "Nemamo šta da vam pošaljemo — sačuvajte stranicu, ona je potvrda.",
    yourBooking: "Vaša rezervacija",
    partyLabel: "{n} gostiju",
    cancel: "Otkaži",
    cancelConfirm: "Otkazati sto?",
    cancelled: "Rezervacija je otkazana.",
    cancelFailed: "Rezervaciju nije bilo moguće otkazati.",
    backToRestaurant: "Na stranicu restorana",
    status: {
      BOOKED: "Rezervisano",
      SEATED: "Sjedite za stolom",
      COMPLETED: "Posjeta je završena",
      CANCELLED: "Otkazano",
      NO_SHOW: "Niko nije došao",
    },
  },
  ...
  account: {
    ...
    greetingNoName: "Dobro došli nazad",
    since: "Gost Burpa od {date}",
    firstVisit: "Vaša prva narudžba — dobro došli.",
    photoTitle: "Vaša slika",
    photoHint: "Slika je privatna. Drugima se prikazuje tek ako to sami odaberete ispod.",
    photoShow: "Prikaži sliku uz moje recenzije",
    photoShowHint: "Recenzija s licem znači više. Izbor možete povući kad god želite.",
    photoPending: "Čeka pregled. Prikazuje se kad je Burp pogleda.",
    photoApproved: "Prikazuje se uz vaše recenzije.",
    photoRejected: "Slika nije odobrena za objavu. Ostaje kao vaša privatna slika.",
    displayNameTitle: "Vaše ime uz recenzije",
    displayNameHint: "Prikazuje se uz vaše recenzije. Ako ostavite prazno, piše samo “Gost”. Vaše pravo ime se nikad ne objavljuje.",
    displayNameLabel: "Ime za prikaz",
    displayNamePlaceholder: "Amina S.",
    displayNameSave: "Sačuvaj ime",
    displayNameSaved: "Ime je sačuvano.",
    displayNameTooLong: "Najviše 40 znakova.",
    alsoSaved: "Drugi su sačuvali i ovo",
    alsoSavedHint: "Izračunato iz onoga što su sačuvali gosti koji su sačuvali ista mjesta kao vi.",
    popularHint: "Trenutno najčešće sačuvana. Kad sačuvate više mjesta, lista postaje vaša.",
    savedBy: "{n} sačuvalo",
    savedByOne: "1 sačuvao",
    featuredIn: "Izdvojeno u gradu {city}",
    featuredHint: "Burpov izbor — nije lista popularnosti.",
    photoChoose: "Odaberite sliku",
    photoRemove: "Ukloni sliku",
    photoUploading: "Otpremanje…",
    photoFormatError: "Slika mora biti JPEG, PNG, WebP ili AVIF.",
    photoSizeError: "Slika može biti najviše 5 MB.",
    photoFailed: "Slika nije sačuvana.",
    yourPlaces: "Vaša mjesta",
    yourDishes: "Šta najčešće naručujete",
    visits: "{n} posjeta",
    visitsOne: "1 posjeta",
    times: "{n} puta",
    timesOne: "1 put",
  ...
  staff: {
    ...
    settings: {
      ...
      reservationEnabled: "Primaj rezervacije",
      reservationEnabledHint: "Isključeno, gost ne vidi obrazac za rezervaciju.",
      reservationDuration: "Trajanje",
      reservationDurationHint: "Minuta po rezervaciji.",
      reservationGrace: "Čekanje",
      reservationGraceHint: "Minuta koliko držite sto onome ko kasni.",
      reservationLead: "Najava",
      reservationLeadHint: "Minuta prije nego se rezervacija zatvori.",
      reservationHorizon: "Unaprijed",
      reservationHorizonHint: "Dana unaprijed.",
      reservationMaxParty: "Najveće društvo",
      reservationMaxPartyHint: "Veći od toga vas zovu.",
    ...
    tables: {
      ...
      bookingTitle: "Kod rezervacije",
      bookingSaved: "Sto je sačuvan.",
      surcharge: "Doplata",
      surchargeHint: "Dodaje se na račun kod vas. Burp nikada ne prima taj iznos.",
    ...
    reports: {
      ...
      exportCsv: "Preuzmi kao CSV",
      exportCsvHint: "Otvara se u Google tabelama i Excelu.",
    ...
    image: {
      ...
      adjustTitle: "Podesi sliku",
      adjustHint: "Kliknite na sliku da odaberete šta ostaje vidljivo kad se isječe.",
      adjustNoReview: "Podešavanja se vide odmah i ne traže novi pregled.",
      brightness: "Osvjetljenje",
      contrast: "Kontrast",
      saturation: "Zasićenje",
      adjustReset: "Vrati na početno",
      adjustSave: "Sačuvaj podešavanje",
    ...
    documents: {
      title: "Dokumenti",
      hint: "Potvrda o alergenima, vinska karta ili katering list kao PDF. Meni ne spada ovdje — uređuje se pod Meni i iz njega se naručuje.",
      empty: "Još nema dokumenata.",
      titleLabel: "Naslov",
      titlePlaceholder: "Vinska karta 2026",
      choose: "Odaberi PDF",
      add: "Dodaj dokument",
      adding: "Otpremanje…",
      remove: "Ukloni",
      removeConfirm: "Ukloniti dokument? To se ne može poništiti.",
      pending: "Čeka pregled",
      rejected: "Odbijeno",
      approved: "Objavljeno",
      needTitle: "Prvo upišite naslov.",
      formatError: "Dokument mora biti PDF.",
      sizeError: "Dokument može biti najviše 10 MB.",
      failed: "Dokument nije sačuvan.",
    },
