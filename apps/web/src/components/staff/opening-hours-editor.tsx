  ...
  return (
    <div className="mt-4">
            ...
            <div className="mt-2 space-y-2">
              ...
              {hours[day].length > 0 ? (
                <button
                  type="button"
                  onClick={() => update(day, [])}
                  className="ml-2 min-h-11 rounded-md border border-black/15 px-4 text-sm dark:border-white/20"
                >
                  Stängt hela dagen
                </button>
              ) : null}
      ...
      <button
        ...
        onClick={save}
        className="mt-4 min-h-12 rounded-md bg-burp-600 px-5 font-medium text-white disabled:opacity-50"
      >
